...
export default function Booking2() {
    ...
    const {selectedSlots, venueId, formData} = location.state || {};
    ...
    return (
        <main className="container" style={{ padding: '40px 16px', maxWidth: '1100px' }}>
            ...
            <div className="stepper">
                ...
                <div className="step-item is-active" data-step-item="2">
                    <div className="step-col">
            ...
            <div className="booking-layout">
                <div className="booking-form-card">
                    ...
                    <div className="step-actions">
                        <Link to = "/Booking1" className="btn btn-outline" data-step-prev disabled state={{ selectedSlots, venueId , formData}}>Quay lại</Link>
                        <Link to = "/Booking3" className="btn btn-primary" data-step-next state={{ selectedSlots, venueId , formData}}>Tiếp tục</Link>
                    </div>
                </div>
